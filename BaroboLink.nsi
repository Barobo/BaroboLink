...
!define FIRMUP_APP_EXE "LinkbotFirmwareRescue\LinkbotFirmwareRescue.exe"
...
SetOutPath "$INSTDIR\LinkbotFirmwareRescue\accessible"
...
SetOutPath "$INSTDIR\LinkbotFirmwareRescue\iconengines"
File "${FIRMUP_DIR}\iconengines\qsvgicon.dll"
File "${FIRMUP_DIR}\iconengines\qsvgicond.dll"
SetOutPath "$INSTDIR\LinkbotFirmwareRescue\imageformats"
...
SetOutPath "$INSTDIR\LinkbotFirmwareRescue\platforms"
